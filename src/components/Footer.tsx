    ...
    return (<div>
        ...
        <div className="flex items-center justify-between" >
            <div className="flex  items-center justify-between" >
                ...
                <a href="https://github.com/Serj-Y" target="_blank" rel="noopener noreferrer">
            ...
            <div className="flex flex-row items-center justify-between" >
                ...
                <button className="text-xs  text-white font-light cursor-pointer transition ease-out hover:scale-125" disabled={lang === "en"} onClick={handleChangeLanguageToEN} >EN</button>
                <p className="text-xs  text-white mx-1" >|</p>
                <button className="text-xs text-white font-light cursor-pointer transition ease-out hover:scale-125" disabled={lang === "ua"} onClick={handleChangeLanguageToUA}>UA</button>
            </div>
        </div>
    </div>
    )
